module.exports = {
	...
	CONFIG:{
		...
		cellNameMap: {
			'0':'-','1':'','2':'公园',
			'51':'自建房','52':'公寓','53':'粮棚','54':'工厂','55':'超市','56':'诊所','57':'妓院','58':'赌场','59':'酒吧',
			'101':'人才市场','102':'商务楼','103':'训练场','104':'防御站','105':'补给站',
			'201':'废墟','202':'峡谷','203':'森林','204':'平野','205':'水坑',
		},
		cellAllNameMap: {
			'0':'空地','1':'道路','2':'公园',
			'51':'自建房','52':'公寓','53':'粮棚','54':'工厂','55':'超市','56':'诊所','57':'妓院','58':'赌场','59':'酒吧',
		...
		monthDayMap: [31,28,31,30,31,30,31,31,30,31,30,31,],
...
map: {
	...
	cells: [{
		price: 1300,
		level: 2, // 等级(1-5)
		completeness: 4000, // 完整度万分比（0-10000）
		capacity: [1,5], // [当前工作人数，最大工作人数]
		type: 0, // [0:空地|1:道路|2:公园|
					51:自建房|52:公寓|53:粮棚|54:工厂|55:超市|56:诊所|57:妓院|58:赌场|59:酒吧|
					101:人才市场|102:商务楼|103:训练场|104:防御站|105:补给站|
					201:废墟|202:峡谷|203:森林|204:平野|205:水坑]
		ownerID: 0,
